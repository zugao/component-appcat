              ...
              resources: [
                ...
                },
                {
                  ...
                  patches: [
                    ...
                    comp.FromCompositeFieldPathHardValue('spec.forProvider.values.metrics.resources.requests.cpu', '100m'),
                    comp.FromCompositeFieldPathHardValue('spec.forProvider.values.metrics.resources.requests.memory', '128Mi'),
                    comp.FromCompositeFieldPathHardValue('spec.forProvider.values.metrics.resources.limits.cpu', '150m'),
                    comp.FromCompositeFieldPathHardValue('spec.forProvider.values.metrics.resources.limits.memory', '192Mi'),
                  ],
                },
              ],
            },
