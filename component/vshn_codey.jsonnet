              ...
              resources: [
                {
                  ...
                  patches: [
                    ...
                    comp.FromCompositeFieldPathWithConvert('spec.parameters.service.disableRegistration', 'spec.parameters.service.forgejoSettings.config.service."DISABLE_REGISTRATION"', 'string'),
