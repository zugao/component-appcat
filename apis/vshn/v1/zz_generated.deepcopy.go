...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VSHNPostgreSQLRestart) DeepCopyInto(out *VSHNPostgreSQLRestart) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VSHNPostgreSQLRestart.
func (in *VSHNPostgreSQLRestart) DeepCopy() *VSHNPostgreSQLRestart {
	if in == nil {
		return nil
	}
	out := new(VSHNPostgreSQLRestart)
	in.DeepCopyInto(out)
	return out
}
