...
import (
	apisv1 "github.com/vshn/component-appcat/apis/v1"
...
func (in *VSHNPostgreSQLStatus) DeepCopyInto(out *VSHNPostgreSQLStatus) {
	*out = *in
	...
	if in.NamespaceDebug != nil {
		in, out := &in.NamespaceDebug, &out.NamespaceDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ProfileDebug != nil {
		in, out := &in.ProfileDebug, &out.ProfileDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PGConfigDebug != nil {
		in, out := &in.PGConfigDebug, &out.PGConfigDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PGClusterDebug != nil {
		in, out := &in.PGClusterDebug, &out.PGClusterDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SecretsDebug != nil {
		in, out := &in.SecretsDebug, &out.SecretsDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.S3BucketDebug != nil {
		in, out := &in.S3BucketDebug, &out.S3BucketDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.S3BackupConfigDebug != nil {
		in, out := &in.S3BackupConfigDebug, &out.S3BackupConfigDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.NetworkPolicyDebug != nil {
		in, out := &in.NetworkPolicyDebug, &out.NetworkPolicyDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.LocalCADebug != nil {
		in, out := &in.LocalCADebug, &out.LocalCADebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.CertificateDebug != nil {
		in, out := &in.CertificateDebug, &out.CertificateDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *VSHNRedisStatus) DeepCopyInto(out *VSHNRedisStatus) {
	*out = *in
	...
	if in.SelfSignedIssuerDebug != nil {
		in, out := &in.SelfSignedIssuerDebug, &out.SelfSignedIssuerDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	...
	if in.CaCertificateDebug != nil {
		in, out := &in.CaCertificateDebug, &out.CaCertificateDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ServerCertificateDebug != nil {
		in, out := &in.ServerCertificateDebug, &out.ServerCertificateDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ClientCertificateDebug != nil {
		in, out := &in.ClientCertificateDebug, &out.ClientCertificateDebug
		*out = make([]apisv1.Condition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
